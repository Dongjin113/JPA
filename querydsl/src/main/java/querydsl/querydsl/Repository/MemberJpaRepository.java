...
public class MemberJpaRepository {
    ...
    public MemberJpaRepository(EntityManager em, JPAQueryFactory queryFactory) {
        this.em = em;
        this.queryFactory = new JPAQueryFactory(em); //SpringBean으로 등록하지 않을시 사용방법
//        QuerydslApplication에 Spring Bean으로 등록시 사용방법
//        RequiredArgsConstructor 을 사용 할 수 있다
...
//      null 뿐만 아니라 ""가 들어올 수도 있어 StringUtils.hasText 를 사용 해 준다
